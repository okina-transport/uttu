...
public class GtfsFlexExporterService {
    ...
    private void generateLocationGroups(String provider, GtfsWriter writer) {
        List<FlexibleStopPlace> flexibleStopPlaces = getFlexibleSopPlacesForProvider(provider);
    ...
    private List<FlexibleStopPlace> getFlexibleSopPlacesForProvider(String provider){
