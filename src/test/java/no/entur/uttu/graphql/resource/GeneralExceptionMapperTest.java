...
public class GeneralExceptionMapperTest {
    ...
    public void rawAccessDeniedExceptionYieldsForbidden() {
        ...
        Assertions.assertEquals(Response.Status.FORBIDDEN.getStatusCode(), rsp.getStatus());
    }
    ...
    public void nestedAccessDeniedExceptionYieldsForbidden() {
        ...
        Assertions.assertEquals(Response.Status.FORBIDDEN.getStatusCode(), rsp.getStatus());
        Assertions.assertEquals("Nope", ((ErrorResponseEntity) rsp.getEntity()).errors.get(0).message);
    }
    ...
    public void nestedNotAuthorizedExceptionYieldsUnauthorized() {
        ...
        Assertions.assertEquals(Response.Status.UNAUTHORIZED.getStatusCode(), rsp.getStatus());
    }
