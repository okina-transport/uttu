...
public class TimetabledPassingTimeTest {
    ...
    public void checkPersistable_maxFieldsSet_success() {
        ...
        new TimetabledPassingTime().withArrivalTime(T3).withArrivalDayOffset(0).withLatestArrivalTime(T2).withLatestArrivalDayOffset(1).withEarliestDepartureTime(T1)
                .withEarliestDepartureDayOffset(2).withDepartureTime(T0).withDepartureDayOffset(3).checkPersistable();
    ...
    public void checkPersistable_departureBeforeArrival_givesException() {
        assertCheckPersistableFails(new TimetabledPassingTime().withArrivalTime(T1).withDepartureTime(T0));
    }

    @Test
    public void checkPersistable_departureBeforeEarliestDeparture_givesException() {
        assertCheckPersistableFails(new TimetabledPassingTime().withDepartureTime(T0).withEarliestDepartureTime(T1));
    }
    ...
    public void checkBeforeOther_maxFieldsSetAllEquals_success() {
        TimetabledPassingTime one = new TimetabledPassingTime().withArrivalTime(T0).withLatestArrivalTime(T0).withEarliestDepartureTime(T0).withDepartureTime(T0);
        TimetabledPassingTime two = new TimetabledPassingTime().withArrivalTime(T0).withLatestArrivalTime(T0).withEarliestDepartureTime(T0).withDepartureTime(T0);
        one.checkBeforeOther(two);
    }

    @Test
    public void checkBeforeOther_maxFieldsSetWithDifferentDayOffset_success() {
        TimetabledPassingTime one = new TimetabledPassingTime().withArrivalTime(T3).withArrivalDayOffset(0).withLatestArrivalTime(T2).withLatestArrivalDayOffset(1).withEarliestDepartureTime(T1)
                                            .withEarliestDepartureDayOffset(2).withDepartureTime(T0).withDepartureDayOffset(3);
        TimetabledPassingTime two = new TimetabledPassingTime().withArrivalTime(T0).withArrivalDayOffset(3).withLatestArrivalTime(T0).withLatestArrivalDayOffset(4).withEarliestDepartureTime(T0)
                                            .withEarliestDepartureDayOffset(5).withDepartureTime(T0).withDepartureDayOffset(6);
        one.checkBeforeOther(two);
    }
